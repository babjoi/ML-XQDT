 ...
 *
 */
public class WebParamAnnotationProcessor implements AnnotationProcessor {
	
    private AnnotationProcessorEnvironment environment;

	public WebParamAnnotationProcessor(AnnotationProcessorEnvironment environment) {
...
//                .getTypeDeclaration("javax.jws.WebParam"); //$NON-NLS-1$
//
