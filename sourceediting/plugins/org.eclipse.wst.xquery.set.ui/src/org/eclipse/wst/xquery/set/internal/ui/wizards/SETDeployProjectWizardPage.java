...
public class SETDeployProjectWizardPage extends WizardPage {
    ...
    protected SETDeployProjectWizardPage(IScriptProject project) {
        ...
        setTitle("Deploy Sausalito Project");
    ...
    private void initializePageFields() {
        ...
        if (info != null) {
            ...
            fVersionText.setText(info.getProjectConfig().getVersion());
    ...
    private void createDescriptionLabels(Composite parent) {
        ...
        fPortalLink.setText("Pressing finish will deploy the selected project in the Sausalito cloud infrastructure.\n"
    ...
    private void createAppNameText(Composite parent) {
        ...
        SWTFactory.createLabel(composite, "Version:", 1);
        fVersionText = SWTFactory.createText(composite, SWT.BORDER, 1, fConfig.getVersion());
