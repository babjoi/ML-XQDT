...
import org.eclipse.jpt.nosql.eclipselink.core.context.persistence.ExclusiveConnectionMode;
 ...
 */
public class NoSqlExclusiveConnectionsPropertiesComposite<T extends Connection> 
	extends Pane<T>
{
	public NoSqlExclusiveConnectionsPropertiesComposite(Pane<T> parentComposite, Composite parent, PropertyValueModel<Boolean> enabledModel) {
