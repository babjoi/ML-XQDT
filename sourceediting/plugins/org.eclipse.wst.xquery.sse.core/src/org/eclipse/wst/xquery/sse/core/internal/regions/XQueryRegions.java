...
public interface XQueryRegions extends DOMRegionContext {
	...
	public static final String KT_DOCUMENTTEST = "KT_DOCUMENTTEST"; //$NON-NLS-1$
	public static final String KT_ELEMENTTEST = "KT_ELEMENTTEST"; //$NON-NLS-1$
	public static final String KT_ATTRIBUTETEST = "KT_ATTRIBUTETEST"; //$NON-NLS-1$
	public static final String KT_SCHEMAELEMENTTEST = "KT_SCHEMAELEMENTTEST"; //$NON-NLS-1$
	public static final String KT_SCHEMAATTRIBUTETEST = "KT_SCHEMAATTRIBUTETEST"; //$NON-NLS-1$
	public static final String KT_TEXTTEST = "KT_TEXTTEST"; //$NON-NLS-1$
