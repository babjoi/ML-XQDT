...
public class EclipseLinkNoSql2_5JpaPlatformFactory
	implements JpaPlatformFactory
{
	/**
	 * See <code>org.eclipse.jpt.jpa.eclipselink.core/plugin.xml:org.eclipse.jpt.jpa.core.jpaPlatforms</code>.
	 */
	public static final String ID = "eclipselink_nosql_2_5"; //$NON-NLS-1$
	 ...
	 */
	public EclipseLinkNoSql2_5JpaPlatformFactory() {
		super();
	}
	...
	public JpaPlatform buildJpaPlatform(JpaPlatform.Config config) {
		return new GenericJpaPlatform(
			...
			EclipseLinkNoSql2_5JpaPlatformProvider.instance(),
			buildJpaVariation(),
