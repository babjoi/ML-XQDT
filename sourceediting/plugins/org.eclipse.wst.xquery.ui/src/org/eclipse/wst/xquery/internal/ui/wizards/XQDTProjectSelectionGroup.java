...
public class XQDTProjectSelectionGroup extends Composite {
     ...
     *            existing ones.
     */
    public XQDTProjectSelectionGroup(Composite parent, Listener listener, boolean allowNewContainerName) {
     ...
     */
    public XQDTProjectSelectionGroup(Composite parent, Listener listener, boolean allowNewContainerName, String message) {
     ...
     */
    public XQDTProjectSelectionGroup(Composite parent, Listener listener, boolean allowNewContainerName,
            String message, boolean showClosedProjects, int heightHint, int widthHint) {
    ...
    public void createContents(String message, int heightHint, int widthHint) {
        ...
        org.eclipse.jface.dialogs.Dialog.applyDialogFont(this);
    }
    ...
    protected void createTreeViewer(int heightHint) {
        ...
        XQDTProjectContentProvider cp = new XQDTProjectContentProvider();
    ...
    /**
     * Returns the currently entered container name. Null if the field is empty. Note that the
