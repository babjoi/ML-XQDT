# Contributing to ML-XQDT

ML-XQDT welcomes new contributors. This document will guide you
through the process.
...
* **ML-XQDT Version** - is it a named version or from our dev branch
...
Fork the project [on GitHub](https://github.com/mcrosier/ML-XQDT/fork) and clone
your copy.

```sh
$ git clone git@github.com:username/ML-XQDT.git
$ cd ML-XQDT
$ git remote add upstream git://github.com/mcrosier/ML-XQDT.git
```

All bug fixes and new features go into the xquery-dev branch.
...
```sh
$ git checkout -b my-feature-branch -t origin/xquery-dev
```
...
```sh
$ git fetch upstream
$ git rebase upstream/xquery-dev
```


#### Test your code

We are working hard to improve ML-XQDT's testing. If you add new functions
in code then please write unit tests in the deploy/test directory.
...
Go to https://github.com/username/ML-XQDT and select your feature branch. Click
...
[issue tracker]: https://github.com/mcrosier/ML-XQDT/issues
