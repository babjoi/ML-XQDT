...
public class XQueryXmlElementContentText extends ASTNode implements IXQDTSemanticPositionProvider {

    private String fValue;

    public XQueryXmlElementContentText(int start, int end, String value) {
        super(start, end);
        fValue = value;
    }
    ...
    public boolean equals(Object obj) {
        if (obj == this)
            return true;
        if (obj instanceof XQueryXmlElementContentText) {
            XQueryXmlElementContentText s = (XQueryXmlElementContentText)obj;
