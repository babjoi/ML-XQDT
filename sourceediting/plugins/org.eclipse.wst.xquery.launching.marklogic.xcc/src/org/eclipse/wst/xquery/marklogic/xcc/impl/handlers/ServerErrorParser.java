...
class ServerErrorParser {
    ...
    private static class SaxHandler extends DefaultHandler {
        ...
        private List<XQueryStackFrame> stackList = new ArrayList<XQueryStackFrame>();
        ...
        public void endElement(String namespaceURI, String localName, String qName) throws SAXException {
            ...
            if (localName.equals("error")) {
                ...
                XQueryStackFrame[] stack = null;

                stack = stackList.toArray(new XQueryStackFrame[stackList.size()]);

                XQueryException eee;

                if (retryable) {
                    eee = new RetryableXQueryException(request, code, w3cCode, xqueryVersion, message, formatString,
                            expr, retryable, data, stack);
                } else {
                    eee = new XQueryException(request, code, w3cCode, xqueryVersion, message, formatString, expr,
            ...
            if (localName.equals("frame")) {
                ...
                stackList.add(new XQueryStackFrame(uri, line, operation, variables, contextItem, contextPosition,
                        xqueryVersion));
...
//
//				if (cls != null && (cls.startsWith ("org.eclipse.wst.xquery.marklogic.xdmp")
//					|| cls.startsWith ("org.eclipse.wst.xquery.marklogic.xdbc")))
//				{
//					break;
//				} else {
//					newvec.add (0, ste);
