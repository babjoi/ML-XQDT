...
public class XQDTUIMessages extends NLS {
    ...
    public static String SyntaxColoringPage_SchemesLabel;
    public static String SyntaxColoringPage_NoSchemeItem;
    public static String SyntaxColoringPage_0;
    public static String SyntaxColoringPage_1;
    ...
    public static String StringLiteral_UI_;
    public static String VarRef_UI_;
    public static String Type_UI_;
    public static String Comment_UI_;
    public static String Operator_UI_;
