...
public class NoSqlPropertiesComposite<T extends NoSqlConnection> extends Pane<T> {

	public NoSqlPropertiesComposite(Pane<T> parentComposite,
	                                Composite parent,
	...
	protected void initializeLayout(Composite container) {
		...
		// TODO
		NoSqlConnectionPropertiesComposite<?> connectionComposite = new MongoDBConnectionPropopertiesComposite<MongoDBConnection>(
			(NoSqlPropertiesComposite<MongoDBConnection>) this,
			container
		);
	...
	private ModifiablePropertyValueModel<Boolean> buildReadConnectionsSharedHolder() {
		return new PropertyAspectAdapter<NoSqlConnection, Boolean>(getSubjectHolder(), NoSqlConnection.READ_CONNECTIONS_SHARED_PROPERTY) {
			@Override
	...
	private PropertyValueModel<Boolean> buildDefaultReadConnectionsSharedHolder() {
		return new PropertyAspectAdapter<NoSqlConnection, Boolean>(
			getSubjectHolder(),
			NoSqlConnection.READ_CONNECTIONS_SHARED_PROPERTY)
		{
			@Override
			protected Boolean buildValue_() {
	...
	private void addReadConnectionsMinCombo(Composite container) {
		new IntegerCombo<NoSqlConnection>(this, container) {
			@Override
			...
			protected ModifiablePropertyValueModel<Integer> buildSelectedItemHolder() {
				return new PropertyAspectAdapter<NoSqlConnection, Integer>(getSubjectHolder(), NoSqlConnection.READ_CONNECTIONS_MIN_PROPERTY) {
					@Override
					protected Integer buildValue_() {
	...
	private void addReadConnectionsMaxCombo(Composite container) {
		new IntegerCombo<NoSqlConnection>(this, container) {
			...
			@Override
			protected ModifiablePropertyValueModel<Integer> buildSelectedItemHolder() {
				return new PropertyAspectAdapter<NoSqlConnection, Integer>(getSubjectHolder(), NoSqlConnection.READ_CONNECTIONS_MAX_PROPERTY) {
					@Override
					protected Integer buildValue_() {
	...
	private void addWriteConnectionsMinCombo(Composite container) {
		new IntegerCombo<NoSqlConnection>(this, container) {
			...
			@Override
			protected ModifiablePropertyValueModel<Integer> buildSelectedItemHolder() {
				return new PropertyAspectAdapter<NoSqlConnection, Integer>(getSubjectHolder(), NoSqlConnection.WRITE_CONNECTIONS_MIN_PROPERTY) {
					@Override
					protected Integer buildValue_() {
	...
	private void addWriteConnectionsMaxCombo(Composite container) {
		new IntegerCombo<NoSqlConnection>(this, container) {
			...
			@Override
			protected ModifiablePropertyValueModel<Integer> buildSelectedItemHolder() {
				return new PropertyAspectAdapter<NoSqlConnection, Integer>(getSubjectHolder(), NoSqlConnection.WRITE_CONNECTIONS_MAX_PROPERTY) {
					@Override
					protected Integer buildValue_() {
