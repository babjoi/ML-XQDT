	...
	extends Pane<PersistenceUnit>
{
	...
	private String buildTargetDatabaseDisplayString(String targetDatabaseName) {
		switch (TargetNoSqlDatabase.valueOf(targetDatabaseName)) {
			case mongodb: return EclipseLinkUiMessages.TargetDatabaseComposite_mongodb;
	...
	private Comparator<String> buildTargetDatabaseComparator() {
		return new Comparator<String>() {
			public int compare(String value1, String value2) {
				value1 = buildTargetDatabaseDisplayString(value1);
				value2 = buildTargetDatabaseDisplayString(value2);
	...
	private Transformer<String, String> buildTargetDatabaseConverter() {
		return new TransformerAdapter<String, String>() {
			...
			public String transform(String value) {
				try {
					TargetNoSqlDatabase.valueOf(value);
...
//		String defaultValue = "mongodb"; /*TODO subject.getDefaultTargetDatabase();*/
//
//		if (defaultValue != null) {
//			return NLS.bind(
//				JptCommonUiMessages.DEFAULT_WITH_ONE_PARAM,
