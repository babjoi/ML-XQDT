 ...
 * cached (default) then all {@link org.eclipse.wst.xquery.marklogic.xcc.types.XdmItem}s have been read and buffered.
...
public interface ResultSequence extends XdmSequence<ResultItem> {
    ...
    /**
     * <p>
     * Fetch the current {@link ResultItem} object in the 1ResultSequence. The method
     * {@link org.eclipse.wst.xquery.marklogic.xcc.ResultItem#isFetchable()} indicates whether the value for this item
     ...
     * @see org.eclipse.wst.xquery.marklogic.xcc.ResultItem#isFetchable()
     * @see #isCached()
     * @see org.eclipse.wst.xquery.marklogic.xcc.ResultItem#isCached()
     */
    ResultItem current();
     ...
     * {@link org.eclipse.wst.xquery.marklogic.xcc.types.XdmItem}s in the sequence. If the non-cached input
     * ResultSequence has been partially iterated, only the remaining
     * {@link org.eclipse.wst.xquery.marklogic.xcc.types.XdmItem}s will be cached. If the current item is not fetchable
     * ({@link org.eclipse.wst.xquery.marklogic.xcc.ResultItem#isFetchable()} returns false), it will be ignored.
     * 
     ...
     * buffer, iterate over each item and use {@link org.eclipse.wst.xquery.marklogic.xcc.ResultItem#asInputStream()}
     ...
     * {@link org.eclipse.wst.xquery.marklogic.xcc.types.XdmItem}s representing the XQuery result. But there may be
