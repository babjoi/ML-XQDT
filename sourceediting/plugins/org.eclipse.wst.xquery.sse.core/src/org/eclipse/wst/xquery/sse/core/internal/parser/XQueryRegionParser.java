...
public class XQueryRegionParser implements StructuredDocumentRegionParser,
	...
	{
		// Group $ VarName
		STARTING_GROUP_FACTORIES.put(XQueryRegions.DOLLAR,
				XQueryStructuredDocumentRegion.Factory.INSTANCE);
		// Group empty ( )
		STARTING_GROUP_FACTORIES.put(XQueryRegions.ST_EMPTY,
				XQueryStructuredDocumentRegion.Factory.INSTANCE);
		// Group item ( )
		...
		STARTING_GROUP_FACTORIES.put(XQueryRegions.KW_ORDERED,
				XQueryStructuredDocumentRegion.Factory.INSTANCE);
		STARTING_GROUP_FACTORIES.put(XQueryRegions.KW_UNORDERED,
				XQueryStructuredDocumentRegion.Factory.INSTANCE);
		STARTING_GROUP_FACTORIES.put(XQueryRegions.PATH_PARENT,
				XQueryStructuredDocumentRegion.Factory.INSTANCE);
		STARTING_GROUP_FACTORIES.put(XQueryRegions.PATH_ANCESTOR,
				XQueryStructuredDocumentRegion.Factory.INSTANCE);
		STARTING_GROUP_FACTORIES.put(XQueryRegions.PATH_ANCESTOR_OR_SELF,
				XQueryStructuredDocumentRegion.Factory.INSTANCE);
		STARTING_GROUP_FACTORIES.put(XQueryRegions.PATH_ATTRIBUTE,
				XQueryStructuredDocumentRegion.Factory.INSTANCE);
		STARTING_GROUP_FACTORIES.put(XQueryRegions.PATH_CHILD,
				XQueryStructuredDocumentRegion.Factory.INSTANCE);
		STARTING_GROUP_FACTORIES.put(XQueryRegions.PATH_DESCENDANT,
				XQueryStructuredDocumentRegion.Factory.INSTANCE);
		STARTING_GROUP_FACTORIES.put(XQueryRegions.PATH_DESCENDANT_OR_SELF,
				XQueryStructuredDocumentRegion.Factory.INSTANCE);
		STARTING_GROUP_FACTORIES.put(XQueryRegions.PATH_FOLLOWING,
				XQueryStructuredDocumentRegion.Factory.INSTANCE);
		STARTING_GROUP_FACTORIES.put(XQueryRegions.PATH_FOLLOWING_SIBLING,
				XQueryStructuredDocumentRegion.Factory.INSTANCE);
		STARTING_GROUP_FACTORIES.put(XQueryRegions.PATH_PRECEDING,
				XQueryStructuredDocumentRegion.Factory.INSTANCE);
		STARTING_GROUP_FACTORIES.put(XQueryRegions.PATH_PRECEDING_SIBLING,
				XQueryStructuredDocumentRegion.Factory.INSTANCE);
		STARTING_GROUP_FACTORIES.put(XQueryRegions.PATH_SELF,
				XQueryStructuredDocumentRegion.Factory.INSTANCE);
		...
		STARTING_GROUP_FACTORIES.put(XQueryRegions.KW_ORDER,
				XQueryStructuredDocumentRegion.Factory.INSTANCE);
		STARTING_GROUP_FACTORIES.put(XQueryRegions.KW_STABLE,
				XQueryStructuredDocumentRegion.Factory.INSTANCE);
	...
	{
		IN_GROUP.put(XQueryRegions.DOLLAR,
				new String[] { XQueryRegions.VARREF });
		IN_GROUP.put(XQueryRegions.ST_EMPTY, new String[] { XQueryRegions.LPAR,
				XQueryRegions.RPAR });
		IN_GROUP.put(XQueryRegions.ST_ITEM, new String[] { XQueryRegions.LPAR,
				XQueryRegions.RPAR });
		IN_GROUP.put(XQueryRegions.FUNCTIONNAME,
				new String[] { XQueryRegions.LPAR });
		IN_GROUP.put(XQueryRegions.KW_ORDERED,
				new String[] { XQueryRegions.LCURLY });
		IN_GROUP.put(XQueryRegions.KW_UNORDERED,
				new String[] { XQueryRegions.LCURLY });
		IN_GROUP.put(XQueryRegions.PATH_PARENT,
				new String[] { XQueryRegions.COLONCOLON });
		IN_GROUP.put(XQueryRegions.PATH_ANCESTOR,
				new String[] { XQueryRegions.COLONCOLON });
		IN_GROUP.put(XQueryRegions.PATH_ANCESTOR_OR_SELF,
				new String[] { XQueryRegions.COLONCOLON });
		IN_GROUP.put(XQueryRegions.PATH_ATTRIBUTE,
				new String[] { XQueryRegions.COLONCOLON });
		IN_GROUP.put(XQueryRegions.PATH_CHILD,
				new String[] { XQueryRegions.COLONCOLON });
		IN_GROUP.put(XQueryRegions.PATH_DESCENDANT,
				new String[] { XQueryRegions.COLONCOLON });
		IN_GROUP.put(XQueryRegions.PATH_DESCENDANT_OR_SELF,
				new String[] { XQueryRegions.COLONCOLON });
		IN_GROUP.put(XQueryRegions.PATH_FOLLOWING,
				new String[] { XQueryRegions.COLONCOLON });
		IN_GROUP.put(XQueryRegions.PATH_FOLLOWING_SIBLING,
				new String[] { XQueryRegions.COLONCOLON });
		IN_GROUP.put(XQueryRegions.PATH_PRECEDING,
				new String[] { XQueryRegions.COLONCOLON });
		IN_GROUP.put(XQueryRegions.PATH_PRECEDING_SIBLING,
				new String[] { XQueryRegions.COLONCOLON });
		IN_GROUP.put(XQueryRegions.PATH_SELF,
				new String[] { XQueryRegions.COLONCOLON });
		...
		IN_GROUP.put(XQueryRegions.KW_MODULE, new String[] {
				...
				XQueryRegions.NCNAME, XQueryRegions.SEPARATOR,
				XQueryRegions.URILITERAL });

		IN_GROUP.put(XQueryRegions.KW_XQUERY, new String[] {
				XQueryRegions.KW_ENCODING, XQueryRegions.KW_VERSION,
				XQueryRegions.SEPARATOR, XQueryRegions.STRINGLITERAL });

		IN_GROUP.put(XQueryRegions.KW_ORDER,
				new String[] { XQueryRegions.KW_BY });
		IN_GROUP.put(XQueryRegions.KW_STABLE, new String[] {
	...
	public void addStructuredDocumentRegionHandler(
			StructuredDocumentRegionHandler handler) {
	...
	public void removeStructuredDocumentRegionHandler(
			StructuredDocumentRegionHandler handler) {
		if (fStructuredDocumentRegionHandlers != null)
	 ...
	 * @return
	 */
	private XQueryStructuredDocumentRegion getStructuredDocumentRegion(
			ITextRegion region) {
		if (inGroup(region))
	...
	protected boolean startGroup(ITextRegion region) {
		final StructuredDocumentRegionFactory factory = STARTING_GROUP_FACTORIES
				.get(region.getType());
		if (factory != null) {
	...
	protected boolean inGroup(ITextRegion region) {
		if (fCurrentStructuredDocumentRegion != null) {
			final String currentType = fCurrentStructuredDocumentRegion
					.getType();

			String[] validRegions = IN_GROUP.get(currentType);
			if (validRegions != null
					&& Arrays.binarySearch(validRegions, region.getType()) >= 0) {
				return true;
			}

			// for declare and import, group all until ";" is found, except for
			// variable and function declaration
			// The separator itself is not included in the group of regions.

			if (currentType == XQueryRegions.KW_DECLARE
					|| currentType == XQueryRegions.KW_IMPORT) {
				if (interruptGroup
						|| region.getType() == XQueryRegions.SEPARATOR)
					return false;
...
//					fCurrentStructuredDocumentRegion = functionDeclRegion;
	...
	protected ITokenizer getContributionTokenizer() {
		...
		IExtensionPoint point = registry.getExtensionPoint(
				"org.eclipse.wst.xquery.sse.core", "tokenizer");
		...
		if (extensions.length > 0) {
			...
			if (elements.length > 0) {
				try {
					tokenizer = (ITokenizer) elements[0]
