...
public interface IXQDTKeywords {
    ...
    public static final String[] KEYWORDS_XQUERY = { "allowing", "ancestor", "ancestor-or-self", "and", "as",
        ...
        "preceding-sibling", "preserve", "previous", "private", "processing-instruction", "return", "satisfies",
            "schema", "schema-attribute", "schema-element", "self", "sliding", "some", "stable", "start", "strict",
            "strip", "switch", "text", "then", "to", "treat", "try", "tumbling", "type", "typeswitch", "union",
            "unordered", "validate", "variable", "version", "when", "where", "window", "xquery", "zero-digit" };
