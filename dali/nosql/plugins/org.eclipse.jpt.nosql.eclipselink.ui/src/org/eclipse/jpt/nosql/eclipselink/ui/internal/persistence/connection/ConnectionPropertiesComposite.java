 ...
 */
public class ConnectionPropertiesComposite<T extends NoSqlConnection>
	extends Pane<T>
{
	...
	protected void initializeLayout(Composite container) {
		...
		NoSqlPropertiesComposite<T> jdbcComposite = new NoSqlPropertiesComposite<T>(this, container, enabledModel);
		GridData gridData = new GridData(GridData.FILL_HORIZONTAL);
		gridData.horizontalSpan = 2;
		jdbcComposite.getControl().setLayoutData(gridData);

		// Exclusive Connections
		NoSqlExclusiveConnectionsPropertiesComposite<T> exclusiveConnectionsComposite = new NoSqlExclusiveConnectionsPropertiesComposite<T>(this, container, enabledModel);
