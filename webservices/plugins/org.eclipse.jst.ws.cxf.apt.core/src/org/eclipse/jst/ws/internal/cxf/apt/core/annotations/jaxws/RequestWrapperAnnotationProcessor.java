 ...
 *
 */
public class RequestWrapperAnnotationProcessor implements AnnotationProcessor {
	
    private AnnotationProcessorEnvironment environment;

	public RequestWrapperAnnotationProcessor(AnnotationProcessorEnvironment environment) {
...
//                .getTypeDeclaration("javax.xml.ws.RequestWrapper"); //$NON-NLS-1$
//
//
