...
//        assertArrayEquals(ids, Utils.getAllIds(idFile));
    ...
    public void testValidateId() {
        ...
        assertEquals(false, Utils.validateId("&"));
        assertEquals(false, Utils.validateId(" "));
        assertEquals(true, Utils.validateId("הצüß$%/()"));
    }
