...
public class XQDTGlobalPreferencesPage extends AbstractConfigurationBlockPreferencePage {

    public XQDTGlobalPreferencesPage() {
    }
    ...
    protected void setDescription() {
        setDescription("General XQuery preferences");
    }
