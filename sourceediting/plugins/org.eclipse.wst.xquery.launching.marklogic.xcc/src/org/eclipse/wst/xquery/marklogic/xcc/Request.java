...
public interface Request {
    ...
    /**
     * Associate the given {@link org.eclipse.wst.xquery.marklogic.xcc.types.XdmVariable} with this Request. If another
     ...
     * 
     * @param variable
     *            A {@link org.eclipse.wst.xquery.marklogic.xcc.types.XdmVariable} instance to be associated with this
     *            Request. If another variable with the same name (
     *            {@link org.eclipse.wst.xquery.marklogic.xcc.types.XName}) is already bound, it will be replaced with
     *            this one. Note that {@link org.eclipse.wst.xquery.marklogic.xcc.types.XName} instances with the same
     *            namespace/local name values are considered to be equal.
     * @throws org.eclipse.wst.xquery.marklogic.xcc.exceptions.UnimplementedFeatureException
     *             If the variable is not a type that can be passed with the Request. Some server
     *             versions only support setting variables that are atomic (no nodes or sequences).
     */
     ...
     *            {@link org.eclipse.wst.xquery.marklogic.xcc.types.XdmValue} to instantiate.
     * @param value
    ...
    /**
     * <p>
     * Convenience method that creates a new {@link org.eclipse.wst.xquery.marklogic.xcc.types.XSString}, binds it to
     * this Request and then returns the new {@link org.eclipse.wst.xquery.marklogic.xcc.types.XSString} instance. This
     ...
     * @return An instance of {@link org.eclipse.wst.xquery.marklogic.xcc.types.XSString}
     */
    ...
    /**
     * <p>
     * Convenience method that creates a new {@link org.eclipse.wst.xquery.marklogic.xcc.types.XSInteger}, binds it to
     * this Request and then returns the new {@link org.eclipse.wst.xquery.marklogic.xcc.types.XSInteger} instance.
     ...
     *            by a long, use
     *            {@link ValueFactory#newValue(org.eclipse.wst.xquery.marklogic.xcc.types.ValueType, Object)} and pass
     *            a {@link java.math.BigInteger} object as the value.
     * @return An instance of {@link org.eclipse.wst.xquery.marklogic.xcc.types.XSInteger}
     */
