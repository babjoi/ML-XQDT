...
//	private static final String SOCKET_PROVIDER_IMPL_PROPERTY = "org.eclipse.wst.xquery.marklogic.xcc.spi.ConnectionProvider";
//	private static final String DEFAULT_CONNECTION_PROVIDER_CLASS = "org.eclipse.wst.xquery.marklogic.xcc.impl.SocketPoolProvider";
     ...
     * @see org.eclipse.wst.xquery.marklogic.xcc.ContentSource
...
//	}
    ...
    private static class ConnectionProviderCache extends LinkedHashMap<Object, ConnectionProvider> {
        private static final long serialVersionUID = 1L;
        int capacity;

        public ConnectionProviderCache(int capacity) {
            super(capacity + 1, 1f, true); // +1 prevents realloc
    ...
    private static final Map<Object, ConnectionProvider> standardProviders = Collections
            .synchronizedMap(new ConnectionProviderCache(STANDARD_PROVIDER_CACHE_SIZE));
    private static final Map<Object, ConnectionProvider> secureProviders = Collections
            .synchronizedMap(new ConnectionProviderCache(SECURE_PROVIDER_CACHE_SIZE));
