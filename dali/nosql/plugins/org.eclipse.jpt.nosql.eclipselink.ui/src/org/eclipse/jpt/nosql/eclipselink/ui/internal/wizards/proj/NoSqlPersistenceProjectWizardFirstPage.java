...
import org.eclipse.jpt.jpa.ui.internal.wizards.proj.AddToEarComposite;
import org.eclipse.jpt.nosql.eclipselink.ui.internal.wizards.proj.model.JpaProjectCreationDataModelProperties;
...
public class NoSqlPersistenceProjectWizardFirstPage
		extends DataModelFacetCreationWizardPage  {
	
	private AddToEarComposite addToEarComposite;
	
	public NoSqlPersistenceProjectWizardFirstPage(IDataModel dataModel, String pageName) {
		super(dataModel, pageName);
		setTitle("EclipseLink NoSQL Persistence Project");
		setDescription("Configure EclipseLink NoSQL Persistence project settings");
