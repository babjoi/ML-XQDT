 ...
 */
public class ZorbaCoreTestPlugin extends Plugin {

    // The plug-in ID
    public static final String PLUGIN_ID = "org.eclipse.wst.xquery..zorba.core.tests";

    // The shared instance
    private static ZorbaCoreTestPlugin plugin;

    /**
     * The constructor
     */
    public ZorbaCoreTestPlugin() {
    }
     ...
     */
    public static ZorbaCoreTestPlugin getDefault() {
        return plugin;
    }
