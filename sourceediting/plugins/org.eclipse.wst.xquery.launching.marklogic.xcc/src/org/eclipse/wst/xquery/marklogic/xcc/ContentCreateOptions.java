...
public class ContentCreateOptions {
     ...
     * {@link DocumentRepairLevel#FULL}, but this option is only applicable when the document format
     ...
     * insertion. The default is false.
     * 
     * @param resolveEntities
     *            A boolean indicating whether entities should be resolved or not.
     ...
     *            The buffer size to pass the the server.
     */
     ...
     * {@link org.eclipse.wst.xquery.marklogic.xcc.ContentbaseMetaData#getForestMap()} method will return a
