 ...
 ******************************************************************************/
package org.eclipse.jpt.nosql.eclipselink.ui.internal.dialogs;
...
public class AddVirtualAttributeDialog extends StatusDialog {
	...
	protected IPackageFragmentRoot getPackageFragmentRoot() {
		try {
			...
			JptNoSQLEclipseLinkUiPlugin.instance().logError(ex);
			return null;
		}
	}
	...
	private void validate() {
		if (StringTools.isBlank(this.getAttributeName())) {
			updateStatus(JptNoSQLEclipseLinkUiPlugin.instance().buildErrorStatus(EclipseLinkUiMessages.AddVirtualAttributeDialog_noNameError));
			return;
		}
		if (this.getMappingKey() == null) {
			updateStatus(JptNoSQLEclipseLinkUiPlugin.instance().buildErrorStatus(EclipseLinkUiMessages.AddVirtualAttributeDialog_noMappingKeyError));
			return;
		}
		if (!this.getAttributeMappingDefinition(this.getMappingKey()).isSingleRelationshipMapping() && 
			...
			updateStatus(JptNoSQLEclipseLinkUiPlugin.instance().buildErrorStatus(EclipseLinkUiMessages.AddVirtualAttributeDialog_noAttributeTypeError));
			return;
		}
		if ((this.getAttributeMappingDefinition(this.getMappingKey()).isSingleRelationshipMapping() || 
				this.getAttributeMappingDefinition(this.getMappingKey()).isCollectionMapping()) &&
				StringTools.isBlank(this.getTargetType())) {
			updateStatus(JptNoSQLEclipseLinkUiPlugin.instance().buildErrorStatus(EclipseLinkUiMessages.AddVirtualAttributeDialog_noTargetTypeError));
			return;
		}
