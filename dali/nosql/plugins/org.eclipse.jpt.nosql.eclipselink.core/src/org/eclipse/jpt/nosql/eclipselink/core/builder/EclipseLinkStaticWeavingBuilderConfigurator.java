 ...
 ******************************************************************************/
package org.eclipse.jpt.nosql.eclipselink.core.builder;
...
import org.eclipse.jpt.nosql.eclipselink.core.EclipseLinkNoSqlPreferences;
...
public class EclipseLinkStaticWeavingBuilderConfigurator
{
	...
	public String getSourceLocationPreference() {
		...
		return EclipseLinkNoSqlPreferences.getStaticWeavingSourceLocation(this.project, this.getDefaultSourceLocation());
	}
	
	public String getTargetLocationPreference() {
		
		return EclipseLinkNoSqlPreferences.getStaticWeavingTargetLocation(this.project, this.getDefaultTargetLocation());
	}
	
	public String getPersistenceInfoPreference() {
		
		return EclipseLinkNoSqlPreferences.getStaticWeavingPersistenceInfo(this.project, this.getDefaultPersistenceInfo());
	}
	
	public String getLogLevelPreference() {
		
		return EclipseLinkNoSqlPreferences.getStaticWeavingLogLevel(this.project, this.getDefaultLogLevel());
	}
	...
	public void setSourceLocationPreference(String location) {
		EclipseLinkNoSqlPreferences.setStaticWeavingSourceLocation(this.project, location);
	}
	
	public void removeSourceLocationPreference() {
		EclipseLinkNoSqlPreferences.setStaticWeavingSourceLocation(this.project, null);
	}
	
	public void setTargetLocationPreference(String location) {
		EclipseLinkNoSqlPreferences.setStaticWeavingTargetLocation(this.project, location);
	}
	
	public void removeTargetLocationPreference() {
		EclipseLinkNoSqlPreferences.setStaticWeavingTargetLocation(this.project, null);
	}
	
	public void setLogLevelPreference(String logLevel) {
		EclipseLinkNoSqlPreferences.setStaticWeavingLogLevel(this.project, logLevel);
	}
	
	public void removeLogLevelPreference() {
		EclipseLinkNoSqlPreferences.setStaticWeavingLogLevel(this.project, null);
	}
	
	public void setPersistenceInfoPreference(String info) {
		EclipseLinkNoSqlPreferences.setStaticWeavingPersistenceInfo(this.project, info);
	}
	
	public void removePersistenceInfoPreference() {
		EclipseLinkNoSqlPreferences.setStaticWeavingPersistenceInfo(this.project, null);
	}
