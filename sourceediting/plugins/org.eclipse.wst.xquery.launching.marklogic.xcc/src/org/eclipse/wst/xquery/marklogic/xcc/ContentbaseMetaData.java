 ...
 * class that throw {@link RequestException} may make one or more calls the the server to obtain
...
public interface ContentbaseMetaData {
     ...
     * {@link org.eclipse.wst.xquery.marklogic.xcc.UserCredentials} object returned by the
     * {@link org.eclipse.wst.xquery.marklogic.xcc.Session#getUserCredentials()} method. It is included here for
     * completeness.
     * </p>
     * 
     ...
     * method {@link org.eclipse.wst.xquery.marklogic.xcc.Session#getContentBaseName()}, this method makes a call to
