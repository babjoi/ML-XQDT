 ...
 * @since 3.2
 */
public final class EclipseLinkNoSqlPreferences {
	...
	/**
	 * @see org.eclipse.jpt.nosql.eclipselink.core.context.persistence.LoggingLevel#getPropertyValue()
	 */
	...
	private static JptNoSqlEclipseLinkCorePlugin getPlugin() {
		return JptNoSqlEclipseLinkCorePlugin.instance();
	}

	private EclipseLinkNoSqlPreferences() {
